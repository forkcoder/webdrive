...
if ($session->remote_validate($_POST['access_key'])===true){  
  if($_SESSION['fcoder_wdrive_access']==1){
    ...
    if($_SESSION['fcoder_wshare_access']==1)
    $data['basetree'].='<div id="share-div" class="tnodeStyle" onClick="webdriveModule.toggleShareInbox()"><img id="snode-img" src="images\\webdrive\\sharedinbox.png" width="20" height="20"/><span>Private Share (<span id="share-links-count-id">0</span>)</span></div><div id="share-links-id"></div>';
