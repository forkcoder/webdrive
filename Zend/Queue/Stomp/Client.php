...
class Zend_Queue_Stomp_Client
{
    ...
    public function __construct(
        ...
        if (($scheme !== null)
            ...
            $this->initDBConnection()->setFrameClass($frameClass);
        }
    }
    ...
    public function __destruct()
    {
        if ($this->initDBConnection()) {
            $this->initDBConnection()->close(true);
        }
    }
    ...
    {
        $this->initDBConnection()->write($frame);
        return $this;
    }
    ...
    {
        return $this->initDBConnection()->read();
    }
    ...
    {
        return $this->initDBConnection()->canRead();
    }
    ...
    {
        return $this->initDBConnection()->createFrame();
    }
}
