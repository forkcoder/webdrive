...
class Zend_Db_Adapter_Pdo_Ibm extends Zend_Db_Adapter_Pdo_Abstract
{
    ...
    public function _connect()
    {
        ...
        $this->initDBConnection()->setAttribute(Zend_Db::ATTR_STRINGIFY_FETCHES, true);

        try {
            if ($this->_serverType === null) {
                $server = substr($this->initDBConnection()->getAttribute(PDO::ATTR_SERVER_INFO), 0, 3);
    ...
    public function lastInsertId($tableName = null, $primaryKey = null)
    {
        ...
        $id = $this->initDBConnection()->lastInsertId();
