...
function db_connect($SERVER ,$USER,$PASSWORD, $DATABASE){
  ...
  <link rel="icon" href="images/bbank_bb_logo.png" type="image/png">
  <link href="styles/style.css" rel="stylesheet" type="text/css" media="screen" />
  </head>
  <body>
  <div id="main-page">
  <div id="banner-menu-bbank">
  <div id="banner-bbank-top">
  <div class="bbankbblogo"><img  src="images/bbank_bb_logo.png" style="width:76px;height:76px" border="0"/></div>
  ...
  $mnt = $mnt.'<div id="footer-main-bbank" class="nav navbar-nav">Developed by ICT CELL, BB Barishal and Powered by ICTIMMD, Head Office. All Rights Reserved.</div>
  </div>
  </body>
  </html>';
